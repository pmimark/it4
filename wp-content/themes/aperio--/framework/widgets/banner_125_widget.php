...
class Ad_125_125_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		<div class="adv-widget">
			...
			<div class="adv-images">
				<span><a href="<?php echo esc_url($instance['ad_125_link_'.$ad_count]); ?>"><img src="<?php echo esc_url($instance['ad_125_img_'.$ad_count]); ?>" alt="" width="125" height="125" /></a></span>
			</div>
	...
	function form($instance)
	{
		...
		<p>
			...
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_img_1'); ?>" name="<?php echo $this->get_field_name('ad_125_img_1'); ?>" value="<?php echo esc_url($instance['ad_125_img_1']); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_1'); ?>">Ad Link:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_link_1'); ?>" name="<?php echo $this->get_field_name('ad_125_link_1'); ?>" value="<?php echo esc_url($instance['ad_125_link_1']); ?>" />
		</p>
        <hr class="gray" />
		<p><strong>Ad 2</strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_2'); ?>">Image Ad Link:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_img_2'); ?>" name="<?php echo $this->get_field_name('ad_125_img_2'); ?>" value="<?php echo esc_url($instance['ad_125_img_2']); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_2'); ?>">Ad Link:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_link_2'); ?>" name="<?php echo $this->get_field_name('ad_125_link_2'); ?>" value="<?php echo esc_url($instance['ad_125_link_2']); ?>" />
		</p>     <hr class="gray" />
		<p><strong>Ad 3</strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_3'); ?>">Image Ad Link:</label>
			<input class="widefat" type="text"  id="<?php echo $this->get_field_id('ad_125_img_3'); ?>" name="<?php echo $this->get_field_name('ad_125_img_3'); ?>" value="<?php echo   esc_url($instance['ad_125_img_3']); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_3'); ?>">Ad Link:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_link_3'); ?>" name="<?php echo $this->get_field_name('ad_125_link_3'); ?>" value="<?php echo esc_url($instance['ad_125_link_3']); ?>" />
		</p>     <hr class="gray" />
		<p><strong>Ad 4</strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_4'); ?>">Image Ad Link:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_img_4'); ?>" name="<?php echo $this->get_field_name('ad_125_img_4'); ?>" value="<?php echo esc_url($instance['ad_125_img_4']); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_4'); ?>">Ad Link:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id('ad_125_link_4'); ?>" name="<?php echo $this->get_field_name('ad_125_link_4'); ?>" value="<?php echo esc_url($instance['ad_125_link_4']); ?>" />
		</p>
	<?php
	}
}
