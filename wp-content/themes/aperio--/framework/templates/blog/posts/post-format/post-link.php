...
<div id="post-<?php the_ID(); ?>" <?php post_class(' post-standard post-entries post-blockquote bg-style-'.$brad_data['grid_blog_style'].' scheme-'.get_post_meta($post->ID , 'brad_quote-scheme' , true).' no-bottom-padding clearfix '); ?> >
