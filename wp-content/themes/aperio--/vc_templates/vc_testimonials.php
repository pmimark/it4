   ...
   $output = $return = '';
	...
	if($css_animation_type == 'iconbox'){
	 ...
	 while ( $testimonials -> have_posts() ) : 
		 ...
		 $return .= '<div class="testimonial-item '.$testimonial_class.' img-align-'.$img_loc.'"><div class="inner-content '.$el_class2.'" data-animation-delay="'.intval($i*$css_animation_delay).'" data-speed="'.$speed.'" data-animation-effect="'.$css_animation.'"><div class="testimonial animated-box ">';
