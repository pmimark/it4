...
-----------------------------------------------*/
	   ...
	   extract( shortcode_atts( array(
			...
			'half_width'        => '',
			'show_icons'        => 'no',
			'success_message'   => __("Success! Your Message Has been Sent","brad-framework"),
			'error_message'     => __("Error! An Error Occured While Sending your Message","brad-framework"),
			'style' => ''
		...
		//Set the Icons
		$field_icons = array();
		$field_icons['name'] = 'fa-user';
		$field_icons['country'] = 'fa fa-globe';
		$field_icons['city'] = 'fa fa-map-marker';
		$field_icons['company'] = 'fa-home';
		$field_icons['website'] = 'fa fa-chain';
		$field_icons['telephone'] = 'fa fa-phone';
		$field_icons['email'] = 'fa fa-envelope-o';
