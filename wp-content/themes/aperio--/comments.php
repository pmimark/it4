...
<!-- You can start editing here. -->
   ...
   <div id="comments">
        <h3 class="title style1 bw-2px dh-2px mb30  divider-primary bc-dark  dw-default color-default"><span><?php comments_number(__('No Comments', 'brad'), __('One Comment', 'brad'), __('% Comments', 'brad'));?></span></h3>
  ...
  <?php
        ...
        $comments_args = array(
			'fields' => $fields,
			'title_reply'=>'<h3 class="title style1 bw-2px dh-2px mb30  divider-primary bc-dark  dw-default color-default"><span>'. __('Leave a reply', 'brad') .'</span></h3>',
